...
for (i in 1:48){
  ...
  net %e% "distance" <- as.matrix(distance)
...
```{r}
tic()
nw.fit.fp2_1 <- btergm(nets ~ edges +transitiveties + mutual + cyclicalties + nodeicov("alsha_occ") + nodeocov("alsha_occ")+nodeicov("alsha_fat") + nodeocov("alsha_fat")+edgecov(distance) +nodematch("region") , R = 50, parallel = "snow", ncpus = 2
)
...
```{r}
tic()
nw.fit.fp3 <- btergm(nets ~ edges +transitiveties + mutual + cyclicalties + nodeicov("alsha_occ") + nodeocov("alsha_occ")+nodeicov("alsha_fat") + nodeocov("alsha_fat")+edgecov(distance) +nodematch("region")+nodeocov("pdi0")+nodeocov("tdi0")+nodeocov("vdi0")+nodeicov("pdi0")+nodeicov("tdi0")+nodeicov("vdi0")+diff("pdi0")+diff("tdi0")+diff("vdi0"), R = 50, parallel = "snow", ncpus = 2
)
toc() # 11.67 sec in laptop
summary(nw.fit.fp3)

tic()
nw.fit.fp4 <- btergm(nets ~ edges +transitiveties + mutual + cyclicalties + nodeicov("alsha_occ") + nodeocov("alsha_occ")+nodeicov("alsha_fat") + nodeocov("alsha_fat")+edgecov(distance) +nodematch("region")+nodeocov("pdi0_p1")+nodeocov("tdi0_p1")+nodeocov("vdi0_p1")+nodeicov("pdi0_p1")+nodeicov("tdi0_p1")+nodeicov("vdi0_p1"), R = 50, parallel = "snow", ncpus = 2
)
toc() # 11.67 sec in laptop
summary(nw.fit.fp4)
```
